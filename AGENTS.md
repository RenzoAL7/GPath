...
un tutorial de Git o un panel de infraestructura. La demo usa ofertas ficticias y
debe decirlo. No agregar autenticación ni una base de datos para cambios de diseño.
